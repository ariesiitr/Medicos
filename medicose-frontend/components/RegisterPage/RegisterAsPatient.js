...
// const Submit =() => {
//   if(patientName===''){
//     toast.warning('Pleaase enter your name')
//   }
//   else if(password ===''){
//     toast.warning('Pleaase enter your password ')
//   }
//   else if(confirmPassword ===''){
//     toast.warning('Pleaase confirm your password ')
//   }
//   else if( gender===''){
//     toast.warning('Pleaase enter gender ')
//   }
//   else if(dob ===''){
//     toast.warning('Pleaase enter your date of birth')
//   }
//   else if(bloodGroup ===''){
//     toast.warning('Pleaase enter your bloodGroup ')
//   }
//   else if(contactNo ===''){
//     toast.warning('Pleaase enter your contact number')
//   }
//   else if(state ===''){
//     toast.warning('Pleaase enter your state')
//   }
//   else if(city ===''){
//     toast.warning('Pleaase enter your city ')
//   }
//   else{
