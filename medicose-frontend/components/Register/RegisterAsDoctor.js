...
const RegisterAsDoctor = () => {
		...
		if (doctorName === '') {
			...
			if (password?.length > 7) {
				if (password === confirmPassword) {
					axios
						.post('http://127.0.0.1:8000/doctor/doctorlogin', {
	...
	return (
		<div>
			<div className="upper">
				{window.innerWidth < 701 ? <MobNavbar /> : <NavbarRegister />}
			</div>
			<div className="main">
				<div className="column">
					<div className="column1">
						<span className="form" htmlFor="doctorName">
							Doctor Name
						</span>
						<input
							type="text"
						...
						<span className="form" htmlFor="password">
							Password
						</span>
						<input
							type="text"
						...
						<span className="form" htmlFor="confirmPassword">
							Confirm Password
						</span>
						<input
							type="text"
						...
						<span className="form" htmlFor="speciality">
							Field
						</span>
						<input
							type="text"
						...
						<span className="form" htmlFor="clinicName">
							Clinic Name
						</span>
						<input
							type="text"
							...
							value={clinicName}
							placeholder="Enter name of your clinic"
							required
						/>

						<span className="form" htmlFor="contactNo">
							Contact Number
						</span>
						<input
							type="number"
						...
						<span className="form" htmlFor="address">
							Address
						</span>
						<input
							type="address"
						...
						<span className="form" htmlFor="availableDays">
							Availibility
						</span>
						<input
							type="text"
					...
					<div className="column2">
						<span className="form" htmlFor="appointmentstartTime">
							Opens at
						</span>
						<input
							type="time"
						...
						<span className="form" htmlFor="appointmentendTime">
							Closes at
						</span>
						<input
							type="time"
						...
						<span className="form" htmlFor="appointmentFees">
							Consultancy fee
						</span>
						<input
							type="text"
						...
						<span className="form" htmlFor="upiId">
							Enter your UPI ID
						</span>
						<input
							type="text"
						...
						<span className="form" htmlFor="license">
							Upload your license:
						</span>
						<input
							type="file"
						...
						<button className="btn-submit" type="submit" onClick={Submit}>
							Submit
						</button>
					</div>
				</div>
