			...
			<div className="main">
				<div className="column">
					<div className="column1">
						<span className="form" htmlFor="patientName">
							Patient Name
						</span>
						<input
							type="text"
						...
						<span className="form" htmlFor="gender">
							Gender
						</span>
						...
						<span className="form" htmlFor="dob">
							Date of Birth
						</span>
						<input
							type="date"
						...
						<span className="form" htmlFor="bloodGroup">
							Blood Group
						</span>
						<select
							type="text"
					...
					<div className="column2">
						...
						<span className="form" htmlFor="state">
							State
						</span>
						...
						<span className="form" htmlFor="city">
							City
						</span>
						<input
							type="text"
