    ...
    <div className="loginContainer">
      ...
      <div className="loginFormContainer">
        ...
        <div className="checkboxContainer">
          <div style={{ display: "flex", flexDirection: "row", height: '18px' }}>
            <input type="checkbox" />
            <label>Remember me</label>
          </div>
          <div style={{color: "#089996", cursor: "pointer"}}>Forgot your password?</div>
        </div>
        <button style={{ backgroundColor: "#089996", color: "#FFFFFF" }}>
          Login
        </button>
        <button>
          <Image
